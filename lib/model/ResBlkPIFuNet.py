...
import functools
from .SurfaceClassifier import SurfaceClassifier_color
...
class ResBlkPIFuNet(BasePIFuNet):
    def __init__(self, opt,
        ...
        self.surface_classifier = SurfaceClassifier_color(
    ...
    def query(self, points, calibs, transforms=None, labels=None):
        ...
        self.preds, self.phi = self.surface_classifier(point_local_feat)
