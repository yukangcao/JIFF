...
class BaseDataset(Dataset):
    ...
    def __init__(self, opt, phase='train'):
        ...
        self.projection_mode = 'orthogonal'  # Declare projection mode here 正交projection

    def __len__(self):
        return 0

    def get_item(self, index): # 得到物体名，b_min，b_max，samples，labels，images，calibration，extrinsic，mask
        ...
        try:
            ...
            return self.get_item(index=random.randint(0, self.__len__() - 1)) #random sample
