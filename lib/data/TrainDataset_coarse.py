...
class TrainDataset_coarse(Dataset):
    @staticmethod
...
#        self.mesh_dic = load_trimesh(self.OBJ)
    ...
    def get_render(self, subject, num_views, yid=0, pid=0, random_sample=False):
        ...
        for vid in view_ids:
            ...
            region = [1, 2, 3, 4]
            region = torch.tensor(region).float()
            region_list = []
        ...
        return {
            ...
            'region': torch.stack(region_list, dim=0)
        }
    ...
    def select_sampling_method(self, subject):
        ...
        #save_samples_truncted_prob('out_Thu_3.ply', samples.T, labels.T)
        #exit()
