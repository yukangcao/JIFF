...
class BFM(object):
    # BFM 3D face model
    def __init__(self, model_path='./Face_Preprocess/BFM/BFM_model_front.mat', device='cpu'):
    ...
    def load_lm3d(self, fsimilarity_Lm3D_all_mat='./Face_Preprocess/BFM/similarity_Lm3D_all.mat'):
...
def load_expbasis():
    ...
    n_vertex = 53215
    exp_bin = open(r'./Face_Preprocess/BFM/Exp_Pca.bin', 'rb')
    exp_dim = array('i')
    ...
    expEV = np.loadtxt(r'./Face_Preprocess/BFM/std_exp.txt')
...
def transfer_BFM09():
    ...
    original_BFM = loadmat(r'./Face_Preprocess/BFM/01_MorphableModel.mat')
    ...
    index_exp = loadmat('./Face_Preprocess/BFM/BFM_front_idx.mat')
    index_exp = index_exp['idx'].astype(
        np.int32) - 1  # starts from 0 (to 53215)

    index_shape = loadmat('./Face_Preprocess/BFM/BFM_exp_idx.mat')
    ...
    other_info = loadmat('./Face_Preprocess/BFM/facemodel_info.mat')
    ...
    # save our face model
    savemat('./Face_Preprocess/BFM/BFM_model_front.mat', {'meanshape': meanshape, 'meantex': meantex, 'idBase': idBase, 'exBase': exBase, 'texBase': texBase,
...
def transfer_UV():
    uv_model = loadmat('./Face_Preprocess/BFM/BFM_UV.mat')

    index_exp = loadmat('./Face_Preprocess/BFM/select_vertex_id.mat')
    index_exp = index_exp['idx'].astype(
        np.int32) - 1  # starts from 0 (to 53215)
